...
- [`src/lib/workbench.ts`](https://github.com/SteveStout/TheYard/blob/main/src/lib/workbench.ts): the workbench, React-free: the cards by slug under their questions, what an address opens, where j and k lead, what the rail's search finds and which card a tile opens.
