...
```live path=api/TheYard.Api/Observability.cs region=azure-events
```
...
[`api/TheYard.Tests/AdminEndpointTests.cs`](https://github.com/SteveStout/TheYard/blob/main/api/TheYard.Tests/AdminEndpointTests.cs),
