...
- **1.0.0.33** (2026-09-03): The nine teaching comments a staging bug dropped from the previous pass are in place, so every region a record shows now opens with one.
- **1.0.0.32** (2026-09-02): Every served document was audited against the code in six classes and the twelve claims that had drifted were corrected, the largest being a record still describing the old 400 body (ADR-017 addendum).
