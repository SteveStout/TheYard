...
86 of the 128 classes in those five projects are sealed, and the 42 that are not are static, which
cannot be inherited either. All 78 records are sealed or record structs, so value comparison means
