...
86 of the 129 classes in those five projects are sealed, and the 43 that are not are static, which
cannot be inherited either. All 79 records are sealed or record structs, so value comparison means
