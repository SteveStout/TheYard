...
89 of the 133 classes in those five projects are sealed, and the 44 that are not are static, which
cannot be inherited either. All 80 records are sealed or record structs, so value comparison means
