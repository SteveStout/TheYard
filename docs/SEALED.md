...
78 of the 114 classes in those five projects are sealed, and the 36 that are not are static, which
cannot be inherited either. All 70 records are sealed or record structs, so value comparison means
