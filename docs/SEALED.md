...
77 of the 111 classes in those five projects are sealed, and the 34 that are not are static, which
cannot be inherited either. All 67 records are sealed or record structs, so value comparison means
