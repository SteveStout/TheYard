...
**The test gate.** Every push runs all three suites in CI: 564 xUnit tests, 118 Vitest tests at 1.0.0.150 and 72 Playwright tests. The ship
...
**The records.** Eighty decision records, each carrying the decision, the trade-off and the number behind
