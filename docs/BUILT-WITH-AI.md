...
**The test gate.** Every push runs all three suites in CI: 487 xUnit tests, 110 Vitest tests at 1.0.0.133 and 64 Playwright tests. The ship
...
**The records.** Seventy-four decision records, each carrying the decision, the trade-off and the number behind
