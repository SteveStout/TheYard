...
**The test gate.** Every version runs all three suites once, in the ship's gate: 610 xUnit tests, 232 Vitest tests at 1.0.3.0 and 97 Playwright tests. The ship
