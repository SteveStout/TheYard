...
**The test gate.** Every push runs all three suites in CI: 502 xUnit tests, 110 Vitest tests at 1.0.0.133 and 68 Playwright tests. The ship
...
**The records.** Seventy-six decision records, each carrying the decision, the trade-off and the number behind
