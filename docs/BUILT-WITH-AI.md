...
**The test gate.** Every push runs all three suites in CI: 406 xUnit tests, 77 Vitest tests at 1.0.0.101 and 58 Playwright tests. The ship
...
**The records.** Seventy decision records, each carrying the decision, the trade-off and the number behind
