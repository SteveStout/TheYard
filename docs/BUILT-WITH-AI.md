...
**The test gate.** Every version runs all three suites once, in the ship's gate: 666 xUnit tests, 232 Vitest tests at 1.0.3.0 and 134 Playwright tests. The ship
...
**The records.** Eighty-three decision records, each carrying the decision, the trade-off and the number behind
