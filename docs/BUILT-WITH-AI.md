...
**The test gate.** Every version runs all three suites once, in the ship's gate: 592 xUnit tests, 231 Vitest tests at 1.0.2.0 and 92 Playwright tests. The ship
