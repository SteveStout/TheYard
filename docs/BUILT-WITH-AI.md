...
**The test gate.** Every push runs all three suites in CI: 544 xUnit tests, 118 Vitest tests at 1.0.0.150 and 70 Playwright tests. The ship
...
**The records.** Seventy-nine decision records, each carrying the decision, the trade-off and the number behind
