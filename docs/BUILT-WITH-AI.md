...
**The test gate.** Every version runs all three suites once, in the ship's gate: 651 xUnit tests, 232 Vitest tests at 1.0.3.0 and 108 Playwright tests. The ship
