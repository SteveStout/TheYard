...
**The test gate.** Every push runs all three suites in CI: 517 xUnit tests, 110 Vitest tests at 1.0.0.133 and 69 Playwright tests. The ship
...
**The records.** Seventy-seven decision records, each carrying the decision, the trade-off and the number behind
