...
- [`src/components/admin/MachinesCard.tsx`](https://github.com/SteveStout/TheYard/blob/main/src/components/admin/MachinesCard.tsx): the card, three readings with their three honesties, and the chart each one is drawn in.
