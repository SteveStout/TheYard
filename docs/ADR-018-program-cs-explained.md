...
It is 1,848 lines, and that is the first thing a reviewer notices, so it is
...
1,848 total
  726 comment
  111 blank
  1,011 code, across 38 endpoints
```

Twenty-seven lines of code per endpoint, and most endpoints are a route, a
