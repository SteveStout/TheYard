...
file (four hundred lines when this was written, 2,615 today) with no class
...
It is 2,494 lines, and that is the first thing a reviewer notices, so it is
...
2,609 total
  918 comment
  149 blank
  1,542 code, across 48 endpoints
```
