...
public static class DiagramPage
{
    ...
    /// every page wears, the glass with the dark green rule and two corner brackets, at the token sheet's values.
    /// </summary>
    public static string Render(string title, string svg, string sourcePath)
    {
        ...
        return $$"""
            ...
            <style>
              html, body { margin: 0; background: #e9e6e7; color: #5e5653; font-family: 'IBM Plex Sans', 'Segoe UI', system-ui, Arial, sans-serif; font-variant-numeric: tabular-nums; }
              ...
              .op-glass { position: relative; max-width: 1600px; margin: 0 auto; padding: 8px; background: rgba(255, 255, 255, 0.42); border: 1px solid rgba(2, 67, 69, 0.18); border-top: 3px solid #024345; border-radius: 10px; box-shadow: 0 8px 24px rgba(2, 67, 69, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.8); }
