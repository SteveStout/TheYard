...
namespace TheYard.Migrations.Sqlite
{
    ...
    [Migration("20260924180000_ActivitySources")]
    partial class ActivitySources
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheYard.Infrastructure.ActivityHourRow", b =>
                {
            ...
            modelBuilder.Entity("TheYard.Infrastructure.ActivityVisitorRow", b =>
                {
                    b.Property<string>("Store")
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("Store", "Day", "Visitor");

                    b.ToTable("ActivityVisitors", (string)null);
                });

            modelBuilder.Entity("TheYard.Infrastructure.BidRow", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TheYard.Infrastructure.PhotoRow", b =>
                {
            ...
            modelBuilder.Entity("TheYard.Infrastructure.VehicleRow", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TheYard.Infrastructure.YardUser", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TheYard.Infrastructure.YardUser", null)
                        .WithMany()
