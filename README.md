...
App Architecture, Hosting, CI/CD and Best Practices in the sidebar. Fifty-six decision
...
- **A sidebar that documents the app from inside it:** App Architecture, Hosting, CI/CD,
  ...
  pages, fifty-six decision records in one numbered index, the Bicep infrastructure, my resume, and
