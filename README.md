...
**API (592 xUnit tests, separate `TheYard.Tests` project):** one suite per onion layer.
...
**Frontend (231 Vitest tests at 1.0.2.0):** presentation logic only, since the API owns the rules.
...
**End-to-end (93 Playwright tests):** the real stack. The landing page shows 100 of
