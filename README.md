...
App Architecture, Hosting, CI/CD and Best Practices in the sidebar. Fifty-seven decision
...
- **A sidebar that documents the app from inside it:** App Architecture, Hosting, CI/CD,
  ...
  pages, fifty-seven decision records in one numbered index, the Bicep infrastructure, my resume, and
...
**API (320 xUnit tests, separate `TheYard.Tests` project):** one suite per onion layer.
