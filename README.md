...
App Architecture, Hosting, CI/CD and Best Practices in the sidebar. Sixty-nine decision
...
**API (384 xUnit tests, separate `TheYard.Tests` project):** one suite per onion layer.
