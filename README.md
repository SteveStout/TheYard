...
**API (658 xUnit tests, separate `TheYard.Tests` project):** one suite per onion layer.
...
**End-to-end (121 Playwright tests):** the real stack. The landing page shows 100 of
