...
const MAKES_MODELS = {
  Toyota: {
    ...
    Corolla: {
      body: 'sedan',
      engines: ['1.8L I4', '2.0L I4', '1.8L Hybrid I4'],
      trims: ['L', 'LE', 'SE', 'XLE', 'XSE'],
    },
    Highlander: {
      body: 'SUV',
      engines: ['2.5L Hybrid I4', '3.5L V6'],
      trims: ['L', 'LE', 'XLE', 'Limited', 'Platinum'],
    },
    Tacoma: {
      body: 'truck',
      engines: ['2.7L I4', '3.5L V6'],
      trims: ['SR', 'SR5', 'TRD Sport', 'TRD Off-Road', 'Limited'],
    },
    Tundra: {
      body: 'truck',
      engines: ['3.5L Twin-Turbo V6', '3.5L Hybrid Twin-Turbo V6'],
  ...
  Honda: {
    Civic: {
      body: 'sedan',
      engines: ['2.0L I4', '1.5L Turbo I4'],
      trims: ['LX', 'Sport', 'EX', 'Touring'],
    },
    'CR-V': {
      body: 'SUV',
      engines: ['1.5L Turbo I4', '2.0L Hybrid I4'],
      trims: ['LX', 'EX', 'EX-L', 'Touring'],
    },
    Accord: {
      body: 'sedan',
      engines: ['1.5L Turbo I4', '2.0L Turbo I4', '2.0L Hybrid I4'],
      trims: ['LX', 'Sport', 'EX-L', 'Touring'],
    },
    Pilot: {
      body: 'SUV',
      engines: ['3.5L V6'],
      trims: ['LX', 'Sport', 'EX-L', 'Touring', 'Elite'],
    },
  },
  Ford: {
    'F-150': {
      body: 'truck',
      engines: ['2.7L EcoBoost V6', '3.5L EcoBoost V6', '5.0L V8', '3.5L PowerBoost Hybrid V6'],
      trims: ['XL', 'XLT', 'Lariat', 'King Ranch', 'Platinum'],
    },
    Escape: {
      body: 'SUV',
      engines: ['1.5L EcoBoost I3', '2.0L EcoBoost I4', '2.5L Hybrid I4'],
      trims: ['S', 'SE', 'SEL', 'Titanium'],
    },
    Explorer: {
      body: 'SUV',
      engines: ['2.3L EcoBoost I4', '3.0L EcoBoost V6', '3.3L Hybrid V6'],
      trims: ['Base', 'XLT', 'Limited', 'ST', 'Platinum'],
    },
    Mustang: {
      body: 'coupe',
      engines: ['2.3L EcoBoost I4', '5.0L V8'],
      trims: ['EcoBoost', 'EcoBoost Premium', 'GT', 'GT Premium', 'Mach 1'],
    },
    Bronco: {
      body: 'SUV',
      engines: ['2.3L EcoBoost I4', '2.7L EcoBoost V6'],
      trims: ['Base', 'Big Bend', 'Black Diamond', 'Outer Banks', 'Wildtrak', 'Badlands'],
    },
  },
  Chevrolet: {
    'Silverado 1500': {
      ...
      trims: ['WT', 'Custom', 'LT', 'RST', 'LT Trail Boss', 'LTZ', 'High Country'],
    },
  ...
  BMW: {
    ...
    X5: {
      body: 'SUV',
      engines: ['3.0L Turbo I6', '4.4L Twin-Turbo V8'],
      trims: ['xDrive40i', 'xDrive45e', 'M50i'],
    },
    '5 Series': {
      body: 'sedan',
      engines: ['2.0L Turbo I4', '3.0L Turbo I6', '4.4L Twin-Turbo V8'],
      trims: ['530i', '530i xDrive', '540i', '540i xDrive', 'M550i'],
    },
  },
  Tesla: {
    'Model 3': {
    ...
    'Model Y': {
      body: 'SUV',
      engines: ['Electric Dual Motor'],
      trims: ['Long Range', 'Performance'],
    },
    'Model S': {
      body: 'sedan',
      engines: ['Electric Dual Motor', 'Electric Tri Motor'],
  ...
  Ram: {
    1500: {
      body: 'truck',
      engines: ['3.6L V6', '5.7L HEMI V8', '3.0L EcoDiesel V6'],
  ...
  Hyundai: {
    Tucson: {
      body: 'SUV',
      engines: ['2.5L I4', '1.6L Turbo Hybrid I4'],
      trims: ['SE', 'SEL', 'N Line', 'Limited'],
    },
    Elantra: {
      body: 'sedan',
      engines: ['2.0L I4', '1.6L Turbo I4', '1.6L Hybrid I4'],
      trims: ['SE', 'SEL', 'N Line', 'Limited', 'N'],
    },
    'Santa Fe': {
      body: 'SUV',
      engines: ['2.5L I4', '2.5L Turbo I4', '1.6L Turbo Hybrid I4'],
  ...
  Kia: {
    Forte: {
      ...
      trims: ['FE', 'LXS', 'GT-Line', 'GT'],
    },
    Sportage: {
      body: 'SUV',
      engines: ['2.5L I4', '1.6L Turbo Hybrid I4'],
      trims: ['LX', 'EX', 'SX', 'SX Prestige', 'X-Pro'],
    },
    Telluride: {
      body: 'SUV',
      engines: ['3.8L V6'],
      trims: ['LX', 'S', 'EX', 'SX', 'SX Prestige', 'X-Pro'],
    },
  },
  Mazda: {
    'CX-5': {
      body: 'SUV',
      engines: ['2.5L I4', '2.5L Turbo I4'],
      trims: ['Sport', 'Select', 'Preferred', 'Carbon Edition', 'Turbo', 'Signature'],
    },
    Mazda3: {
      body: 'sedan',
      engines: ['2.0L I4', '2.5L I4', '2.5L Turbo I4'],
      trims: ['GX', 'GS', 'GT', 'Turbo'],
    },
  },
  Subaru: {
    Outback: {
      body: 'SUV',
      engines: ['2.5L I4', '2.4L Turbo I4'],
      trims: ['Base', 'Premium', 'Limited', 'Touring', 'Wilderness', 'Onyx Edition XT'],
    },
    Crosstrek: {
      body: 'SUV',
  ...
  Volkswagen: {
    ...
    Tiguan: {
      ...
      trims: ['S', 'SE', 'SE R-Line', 'SEL', 'SEL R-Line'],
    },
  ...
  Jeep: {
    Wrangler: {
      body: 'SUV',
      engines: ['2.0L Turbo I4', '3.6L V6', '3.0L EcoDiesel V6'],
      trims: ['Sport', 'Sport S', 'Sahara', 'Rubicon'],
    },
    'Grand Cherokee': {
      body: 'SUV',
      engines: ['2.0L Turbo I4', '3.6L V6', '5.7L HEMI V8'],
      trims: ['Laredo', 'Limited', 'Overland', 'Summit', 'Trailhawk'],
    },
  },
  Nissan: {
...
const DEALERSHIPS_BY_PROVINCE = {
  ...
  Quebec: [
    'Champlain Motors',
    'Laurentian Auto Group',
    'Metropolitain Auto',
    'Rive-Sud Motors',
    'St-Laurent Auto Exchange',
  ],
  'British Columbia': [
    'Fraser Valley Auto Group',
    'Harbour City Auto',
    'Island Auto Exchange',
    'Mountain View Motors',
    'Pacific Gateway Motors',
    'Westcoast Auto Sales',
  ],
  Alberta: [
    'Chinook Auto Group',
    'Foothills Auto Sales',
    'Northern Ridge Motors',
    'Prairie Motors',
...
function generateCondition(year, odometerKm, titleStatus) {
  ...
  const reportGroup =
    CONDITION_REPORTS.find((group) => grade >= group.min && grade <= group.max) ??
    CONDITION_REPORTS[1];
...
function estimatePrice(year, make, model, odometerKm, conditionGrade, titleStatus) {
  ...
  const reservePrice =
    rand() < 0.7 ? roundToNearest500(wholesaleValue * randomBetween(0.85, 0.98)) : null;
  const buyNowPrice =
    rand() < 0.2 ? roundToNearest500(wholesaleValue * randomBetween(1.02, 1.18)) : null;
...
function generateBidState(startingBid, reservePrice, buyNowPrice) {
  ...
  const softCeiling =
    reservePrice ?? buyNowPrice ?? roundToNearest500(startingBid * randomBetween(1.3, 2.4));
  let currentBid = roundToNearest500(
    Math.max(startingBid + 500, softCeiling * randomBetween(0.72, 1.02))
  );
...
function generateVehicle(index) {
  ...
  const { conditionGrade, conditionReport, damageNotes } = generateCondition(
    year,
    odometerKm,
    titleStatus
  );
  const { province, city } = pickProvinceAndCity();
  const { startingBid, reservePrice, buyNowPrice } = estimatePrice(
    year,
    make,
    model,
    odometerKm,
